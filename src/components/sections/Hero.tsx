...
export function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-navy-950 text-white">
      ...
      <Container className="flex min-h-[640px] items-center py-16 sm:min-h-[700px] lg:min-h-[750px]">
        <div className="max-w-[680px]">
          ...
          <p className="mt-8 max-w-xl text-base leading-7 text-silver-100 sm:text-lg">
            Licensed plumbing, drainage and gas services delivered with clear advice,
            quality workmanship and personal accountability from Harry.
          </p>
